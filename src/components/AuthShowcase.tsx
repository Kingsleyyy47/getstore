export default function AuthShowcase() {
  return (
    <div className="relative hidden overflow-hidden bg-gradient-to-br from-emerald-950 via-green-900 to-emerald-800 p-12 text-white lg:flex lg:w-1/2 lg:flex-col lg:justify-between">
